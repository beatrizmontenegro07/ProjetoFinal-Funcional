defmodule GerenciadorFinancasWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(GerenciadorFinancasWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(GerenciadorFinancasWeb.Gettext, "errors", msg, opts)
    end
  end
