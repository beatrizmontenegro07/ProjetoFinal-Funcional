defmodule GerenciadorFinancasWeb.ExpenseControllerTest do
  use GerenciadorFinancasWeb.ConnCase

  import GerenciadorFinancas.FinanceFixtures

  @create_attrs %{date: ~D[2024-10-20], description: "some description", category: "some category", amount: "120.5"}
